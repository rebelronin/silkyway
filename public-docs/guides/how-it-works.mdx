...
<Steps>
  ...
  <Step title="Or recipient declines">
    The recipient can decline the transfer instead of claiming it. Tokens return to the sender. Transfer status becomes `Declined`.
  </Step>
</Steps>
